...
CREATE TABLE `bookmarks` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `bookmarks_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`),
...
INSERT INTO `countries` VALUES ('ee59170a-d891-440a-b53b-6b0c28852412','2024-03-19 21:49:01','2024-03-19 21:49:01','Nigeria','NG','+234'),('ee638fed-f43b-4689-af4b-90d7b5fcca98','2024-03-19 21:45:34','2024-03-19 21:45:34','Nigeria','NG','+234');
...
INSERT INTO `states` VALUES ('9e8b3961-7b1c-4e6d-8e59-db8cde524981','2024-03-19 21:51:27','2024-03-19 21:51:27','New State','ee59170a-d891-440a-b53b-6b0c28852412');
...
-- Dump completed on 2024-03-19 17:57:16
