                    ...
                    if (void 0 !== n) {
                            ...
                            s.slidesPerColumn > 1 &&
                                ((M =
                                    ...
                                    h / e.params.slidesPerColumn
                                        ? h
                                        : Math.ceil(h / s.slidesPerColumn) *
                                          s.slidesPerColumn),
                                "auto" !== s.slidesPerView &&
                                    "row" === s.slidesPerColumnFill &&
                                    (M = Math.max(
                                        M,
                                        s.slidesPerView * s.slidesPerColumn
                                    )));
                        for (
                            var P,
                                k,
                            ...
                            if ("none" !== D.css("display")) {
                                if ("auto" === s.slidesPerView) {
                                    ...
                                    (z =
                                        (n - (s.slidesPerView - 1) * E) /
                                        s.slidesPerView),
                                        s.roundLengths && (z = Math.floor(z)),
                                        u[A] &&
                                            (u[A].style[t("width")] = z + "px");
                        ...
                        if (s.slidesPerColumn > 1)
                            if (
                                ...
                                (e.virtualSize =
                                    Math.ceil(
                                        e.virtualSize / s.slidesPerColumn
                                    ) - s.spaceBetween),
                                r.css(
                                    (((L = {})[t("width")] =
                                        e.virtualSize + s.spaceBetween + "px"),
                        ...
                        if (!s.centeredSlides) {
                            ...
                            (v = P),
                                Math.floor(e.virtualSize - n) -
                                    Math.floor(v[v.length - 1]) >
                                    1 && v.push(e.virtualSize - n);
                        }
                        if (
                            (0 === v.length && (v = [0]), 0 !== s.spaceBetween)
                        ) {
                            var ie,
                                se =
                                    e.isHorizontal() && o
                ...
                slideTo: function(e, t, a, i) {
                    ...
                    if (l.cssMode) {
                        var x,
                            ...
                            C = -g;
                        if (
                            (u && (C = h.scrollWidth - h.offsetWidth - C),
                            0 === t)
                        )
